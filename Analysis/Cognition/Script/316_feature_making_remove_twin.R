...
load(paste0(dir.processing, "/Output/ts_remove_twin/mean.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/sd.RData"))
load(paste0(dir.processing, "/Output/twin_filtered_subject_id.RData"))
# load(paste0(dir.processing, "/Output/filtered_id.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/pacf1.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/pacf2.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/pacf3.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/acf2.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/acf3.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/acf4.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/yy_cor.RData"))
load(paste0(dir.processing, "/Output/ts_remove_twin/snr.RData"))
...
subject_id <- twin_filtered_subject_id
...
variable <- paste0(variable, "_remove_twin")
