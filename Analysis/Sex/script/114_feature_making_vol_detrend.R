...
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/mean.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/sd.RData"))
load(paste0(dir.processing, "/Output/subject_id_all.RData"))
# load(paste0(dir.processing, "/Output/filtered_id.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/pacf1.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/pacf2.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/pacf3.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/acf2.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/acf3.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/acf4.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/yy_cor.RData"))
load(paste0(dir.processing, "/Output/ts_volume_matched_detrend/snr.RData"))
