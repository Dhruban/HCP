...
getdata <- function(index, splitratio) {
  ...
  print(transformed_elvisha$index)
  ...
  # transformed_elvisha_train <- transformed_elvisha_train %>% 
  #   mutate(index = 1:dim(transformed_elvisha_train)[1])
  # minus_train_index <- transformed_elvisha_train %>%
  #   filter(!(Subject %in% second_twin_subject_id))
  # minus_train_index <- minus_train_index$index
  # 
  # print("minus_train_index")
  # print(length(minus_train_index))
  
  test_data <- subset(mydata, split == "FALSE")
  # transformed_elvisha_test <- filter(transformed_elvisha, split == "FALSE")
  # transformed_elvisha_test <- transformed_elvisha_test %>% 
  #   mutate(index = 1:dim(transformed_elvisha_test)[1])
  # minus_test_index <- transformed_elvisha_test %>%
  #   filter(!(Subject %in% second_twin_subject_id))
  # minus_test_index <- minus_test_index$index
  
  # print("minus_test_index")
  # print(length(minus_test_index))
  # transformed_elvisha_test <- filter(transformed_elvisha, split == "FALSE")
  # 
  ...
  # # for(i in 1:j) {
  #   # train_minus <- sample(minus_train_index,4*j)
  ...
  #   test_minus <- sample(minus_test_index,1*j)
