...
load(paste0(dir.processing, "/Output/timeseries_volume_matched/mean.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/sd.RData"))
# load(paste0(dir.processing, "/Output/subject_id_all.RData"))
load(paste0(dir.processing, "/Output/filtered_id.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/pacf1.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/pacf2.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/pacf3.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/acf2.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/acf3.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/acf4.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/yy_cor.RData"))
load(paste0(dir.processing, "/Output/timeseries_volume_matched/snr.RData"))
