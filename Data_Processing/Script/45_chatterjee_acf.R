...
save(chatterjee_acf1, file = paste0(dir_output, "/chatterjee_acf1.RData"))
save(chatterjee_acf2, file = paste0(dir_output, "/chatterjee_acf2.RData"))
save(chatterjee_acf3, file = paste0(dir_output, "/chatterjee_acf3.RData"))
